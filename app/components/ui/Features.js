    ...
    <div className="w-full flex flex-col items-center justify-center">
      ...
      <div className="grid md:grid-cols-3 grid-cols-1 items-center justify-center gap-5 md:px-16 max-w-screen-lg md:max-h-[1200px]">
        <div className="flex flex-col md:items-start items-center space-y-5 lg:p-6 md:mt-20">
          ...
          <p className="text-sm text-center md:text-start px-10 md:px-0">
        ...
        <div className="flex flex-col space-y-5 md:mt-48 md:pl-20 mb-6">
          ...
          <p className="md:text-start text-center text-sm px-10 md:px-0">
      ...
      <div className="flex flex-col">
        <div className="grid md:grid-cols-2 grid-cols-1 gap-6 items-center justify-center p-3 md:w-[800px] md:h-[500px]">
          ...
          <div className="md:space-y-8 space-y-4 flex flex-col items-center md:items-start">
            ...
            <p className="text-sm text-center md:text-start">
              ...
              can support the causes you&apos;re passionate about and build a
              better future for Africa.
            </p>
            <Button
              size="lg"
              variant="outline"
              className="bg-orange-200 p-4 rounded-full text-gray-900 shadow-lg shadow-gray-400"
            >
              Start your journey
            </Button>
          </div>
        ...
        {/* Third section */}
        <div className=" bg-gradient-to-b from-teal-900 to-teal-600 block md:flex items-center p-0 rounded-3xl md:h-80 h-[450px] mt-20 w-full max-w-[850px]">
          <div className="flex flex-col items-center mt-10 md:mt-0 md:ml-20 md:items-start">
            <span className="md:text-5xl text-3xl text-center text-gray-200 font-bold text-nowrap mb-3">
            ...
            <Button
              size="lg"
              variant="outline"
              className="bg-orange-200 p-4 rounded-full -mb-10 text-gray-900 shadow-lg shadow-gray-400"
            >
              Start your journey
            </Button>
          </div>
          ...
          <Image
            ...
            height={723}
            width={723}
            className=" md:mt-36 md:z-50 md:-ml-28 md:w-full md:h-full px-5 md:px-0 h-auto w-auto"
          />
        </div>
      </div>
    </div>
